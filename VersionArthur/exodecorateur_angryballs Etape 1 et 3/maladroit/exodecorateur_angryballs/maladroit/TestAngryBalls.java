...
public class TestAngryBalls
{
	...
	public static void main(String[] args) throws InterruptedException
	{
		...
		Bille red = new BilleConcrete(p1, rayon, v1, Color.red.getRGB());
		red = new ComportementBilleRebondir(red);
		red = new ComportementBilleRectUniforme(red);
		red = new ComportementBilleFlamme(red, false);
		billes.add(red);
		
		// Bille jaune Newton avec pesanteur, frottements et rebond
		Bille yellow = new BilleConcrete(p2, rayon, v2, Color.yellow.getRGB());
		...
		yellow = new ComportementBilleFlamme(yellow, false);
		billes.add((Bille)yellow);
		
		// Bille verte Newton avec frottements et rebond
//		Bille green = new BilleConcrete(p3, rayon, v3, Color.green.getRGB());
//		green = new ComportementBilleRebondir(green);
//		green = new ComportementBilleFlamme(green, false);
...
//		Bille cyan = new BilleConcrete(p4, rayon, v4, Color.cyan.getRGB());
//		cyan = new ComportementBilleRectUniforme(cyan);
//		cyan = new ComportementBilleTraverserMur(cyan);
//		cyan = new ComportementBilleFlamme(cyan, false);
//		billes.add((Bille)cyan);
//		
		// Bille noir hurlante Newton
		Bille noire = new BilleConcrete(p5, rayon, v5, Color.black.getRGB());
		...
		noire = new ComportementBilleFlamme(noire, false);
		...
		Bille azur = new BilleConcrete(p0, rayon, v0, couleurBleuAzur);
		azur = new ComportementBilleFlamme(azur, true);
...
//		Bille rose = new BilleConcrete(p, rayon, v, Color.pink.getRGB());
