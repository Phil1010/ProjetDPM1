 ...
 * 
 * Aucune des classes du package maladroit.modele ne doit faire de r�f�rence �
 * des classes de java.awt ni � aucune autre librairie graphique JAVA car le
 * mod�le NE DOIT PAS d�pendre de la vue !!! Vous devez faire les modifications
 * en cons�quence !! Exploitez les Design Patterns.
 * 
 * On rappelle que ces r�f�rences � une librairie graphique sont n�fastes car si
...
public class BilleConcrete extends Bille {
     ...
     * @param couleur
     */
    protected BilleConcrete(Vecteur centre, double rayon, Vecteur vitesse, Vecteur acceleration, Color couleur) {
